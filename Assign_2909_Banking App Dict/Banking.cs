...
namespace Assign_2909_Banking_App_Dict
{
    public class Banking
    {
        ...
        public static ConcurrentDictionary<decimal, Account> list = new ConcurrentDictionary<decimal, Account>();
        ...
        public void createAcc(Account acc, decimal opening, string accName)
        {
            ...
            if (!list.Keys.Contains(acc.accNumber))
            {
                acc.netBalance = acc.initialBalance;
                list.TryAdd(acc.accNumber, acc);
            }
        }
